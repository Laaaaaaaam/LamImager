...
hidden_imports = collect_submodules('uvicorn') + collect_submodules('aiosqlite') + [
    ...
    'app.services.plan_execution_service',
    'app.services.planning_context',
    ...
    'app.core.agent.graph',
    'app.core.agent.graph_llm',
    'app.core.agent.graph_tools',
    'app.core.agent.capability_prompts',
    'app.core.agent.llm_call_logger',
    'app.core.agent.critic_interface',
    'app.core.agent.nodes',
    'app.core.agent.nodes.intent_node',
    'app.core.agent.nodes.skill_matcher_node',
    'app.core.agent.nodes.skill_node',
    'app.core.agent.nodes.context_node',
    'app.core.agent.nodes.planner_node',
    'app.core.agent.nodes.prompt_builder_node',
    'app.core.agent.nodes.critic_node',
    'app.core.agent.nodes.decision_node',
    'app.middleware',
]
